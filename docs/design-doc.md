...
## [2. Core Geometric Elements](#2-core-geometric-elements)

- [2.1 B-Splines and Béziers](#21-b-splines-and-béziers)
- [2.2 Interactivity](#22-interactivity)
- [2.3 Construction Geometry](#23-construction-geometry)

## [3. Editing Tools](#3-editing-tools)

## [4. Constraints](#4-constraints)

- [4.1 Required Constraints: Geometric](#41-required-constraints-geometric)
  - [4.1.1 Coincident](#411-coincident)
  - [4.1.2 Parallel](#412-parallel)
  - [4.1.3 Perpendicular](#413-perpendicular)
  - [4.1.4 Tangent](#414-tangent)
  - [4.1.5 Concentric](#415-concentric)
  - [4.1.6 Collinear](#416-collinear)
  - [4.1.7 Horizontal](#417-horizontal)
  - [4.1.8 Vertical](#418-vertical)
  - [4.1.9 Equal](#419-equal)
  - [4.1.10 Symmetric](#4110-symmetric)
  - [4.1.11 Midpoint](#4111-midpoint)
- [4.2 Required Constraints: Dimensional](#42-required-constraints-dimensional)
  - [4.2.1 Length](#421-length)
  - [4.2.2 Distance](#422-distance)
  - [4.2.3 Vertical Distance](#423-vertical-distance)
  - [4.2.4 Horizontal Distance](#424-horizontal-distance)
  - [4.2.5 Angle](#425-angle)
  - [4.2.6 Diameter](#426-diameter)
- [4.3 Constraint Support Matrices](#43-constraint-support-matrices)
  - [4.3.1 Unary Constraints - Geometric](#431-unary-constraints---geometric)
  - [4.3.2 Unary Constraints - Dimensional](#432-unary-constraints---dimensional)
  - [4.3.3 Binary/Ternary Constraints - Geometric](#433-binaryternary-constraints---geometric)
  - [4.3.4 Binary Constraints - Dimensional](#434-binary-constraints---dimensional)

## [5. Constraint Solver](#5-constraint-solver)

- [5.1 Method Overview](#51-method-overview)
  - [5.1.1 Example Residual Functions](#511-example-residual-functions)
- [5.2 Structural Pre-processing](#52-structural-pre-processing)
  - [5.2.1 System Decomposition](#521-system-decomposition)
  - [5.2.2 Symbolic Substitution](#522-symbolic-substitution)
...
- [6.1 Visual Constraint State Indication](#61-visual-constraint-state-indication)
- [6.2 Constraint Conflict Resolution](#62-constraint-conflict-resolution)
- [6.3 Interactive Constraint Management](#63-interactive-constraint-management)

## Appendices

- [Appendix A: Useful Links](#appendix-a-useful-links)
- [Appendix B: References](#append-b-references)

---

## 1. Overview

This document is intended to outline functional requirements for a 2D 'sketcher', and owes a debt to Max Margorskyi's 'Advanced Constraint Workflows' document, which outlined high-level requirements.

The required functionality is discussed primarily from a user requirement perspective, but also includes implementation details and illustration of the underlying mathematics and solve method.

### 1.1 Related Documents

For Zoo employees, see `250709-SketcherRequirementsRework` in the MechEng shared drive.
...
- [A Comprehensive Evaluation of the DFP Method for Geometric Constraint Solving Algorithm Using PlaneGCS](https://hrcak.srce.hr/file/446424)
...
[^9]: https://www.cambridge.org/highereducation/books/data-driven-science-and-engineering/6F9A730B7A9A9F43F68CF21A24BEC339#overview
